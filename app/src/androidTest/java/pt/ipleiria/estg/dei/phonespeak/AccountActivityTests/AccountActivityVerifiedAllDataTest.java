...
public class AccountActivityVerifiedAllDataTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void accountActivityVerifiedAllDataTest() {
        ...
        appCompatEditText2.perform(replaceText("S2FA8EX"), closeSoftKeyboard());
