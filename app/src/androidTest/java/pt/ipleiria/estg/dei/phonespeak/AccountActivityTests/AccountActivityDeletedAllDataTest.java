...
public class AccountActivityDeletedAllDataTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void accountActivityDeletedAllDataTest() {
        ...
        appCompatEditText2.perform(replaceText("0XFGHE64E"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withText("Delete"), isDisplayed()));
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewMessage), withText("Username and API Key have been deleted."),
                        childAtPosition(
                                childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        textView.check(matches(withText("Username and API Key have been deleted.")));
