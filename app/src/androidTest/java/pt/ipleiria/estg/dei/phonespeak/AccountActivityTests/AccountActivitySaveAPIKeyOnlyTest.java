...
public class AccountActivitySaveAPIKeyOnlyTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void accountActivitySaveAPIKeyOnlyTest() {
        ...
        appCompatEditText.perform(replaceText("0SX64"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewMessage), withText("API Key has been saved"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        textView.check(matches(withText("API Key has been saved")));
