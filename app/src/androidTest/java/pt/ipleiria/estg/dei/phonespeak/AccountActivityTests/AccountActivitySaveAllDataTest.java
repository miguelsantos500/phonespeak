...
public class AccountActivitySaveAllDataTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void accountActivitySaveAllDataTest() {
        ...
        appCompatEditText2.perform(replaceText("FSX654JFDS"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewMessage), withText("All user data has been saved"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        textView.check(matches(withText("All user data has been saved")));
