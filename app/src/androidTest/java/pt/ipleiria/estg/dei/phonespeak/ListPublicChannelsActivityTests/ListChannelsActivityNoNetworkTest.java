...
public class ListChannelsActivityNoNetworkTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void listPublicChannelsActivityNoNetworkTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.txtErrorLog), withText("No Network! Please try again!"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        textView.check(matches(withText("No Network! Please try again!")));
