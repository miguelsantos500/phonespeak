...
public class ListChannelActivityNoChannelsToShowTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void listChannelActivityNoChannelsToShowTest() {
        ...
        appCompatEditText.perform(replaceText("testing1234"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.txtErrorLog),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("You have no channels to show.")));
