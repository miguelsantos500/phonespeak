...
public class AccountActivitySaveUsernameOnlyTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void accountActivitySaveUsernameOnlyTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewMessage), withText("Username has been saved"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        textView.check(matches(withText("Username has been saved")));
