...
public class AccountActivityVerifyAPIKeyOnlyTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void accountActivityVerifyAPIKeyOnlyTest() {
        ...
        appCompatEditText.perform(replaceText("0XFG64SAV"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewMessage), withText("We can't verify the API Key without the username"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        textView.check(matches(withText("We can't verify the API Key without the username")));
