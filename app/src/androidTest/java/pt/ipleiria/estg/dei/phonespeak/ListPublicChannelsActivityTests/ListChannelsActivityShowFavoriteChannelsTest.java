...
public class ListChannelsActivityShowFavoriteChannelsTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void listChannelsActivityShowFavoriteChannelsTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewLblID), withText("ID:"),
                        childAtPosition(
                                childAtPosition(
