...
public class AccountActivityErrorVerifyingUsernameOnlyTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void accountActivityErrorVerifyingUsernameOnlyTest() {
        ...
        appCompatEditText.perform(replaceText("Han"), closeSoftKeyboard());
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.editTextUsername),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText.check(matches(withText("Han")));

        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewMessage),
                        childAtPosition(
                                childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        textView.check(matches(withText("User Han does not exist")));
