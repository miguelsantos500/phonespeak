...
public class ListChannelsActivityOnlyUsernameInsertedTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void listChannelsActivityOnlyUsernameInsertedTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.txtErrorLog),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("If you want to see your private channels, please update your API Key.")));
