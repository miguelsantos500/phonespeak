...
public class ListPublicCannelsActivityRemoveFavoriteChannelCancelTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void listPublicCannelsActivityRemoveFavoriteChannelCancelTest() {
