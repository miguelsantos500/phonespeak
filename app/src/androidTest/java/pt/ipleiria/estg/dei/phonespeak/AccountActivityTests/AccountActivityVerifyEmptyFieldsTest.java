...
public class AccountActivityVerifyEmptyFieldsTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void accountActivityVerifyEmptyFieldsTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewMessage), withText("You must first insert data before verifying"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        textView.check(matches(withText("You must first insert data before verifying")));
